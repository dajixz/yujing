...
public class QiniuUtil {
    ...
    String ACCESS_KEY = "pX65IXqDTcu4e_n6qUKKgFZgIxIzymRjXv6dFoaP"; //这两个登录七牛 账号里面可以找到
    String SECRET_KEY = "j7qiCZIVrE847jPTeJueu0jNVfqhdose08GBCB4_";

    //要上传的空间
    String bucketname = "yujing"; //对应要上传到七牛上 你的那个路径（自己建文件夹 注意设置私有）
    //上传到七牛后保存的文件名
...
//        String fileName = "xiao.png";
//        //上传文件的路径
//        String FilePath = "C:\\Users\\Administrator\\Desktop\\s.png";  //本地要上传文件路径
//         new QiniuUtil().upload(FilePath,fileName);

        //构造私有空间的需要生成的下载的链接；
//        //格式： http://私有空间绑定的域名/空间下的文件名
        String targetUrl = "http://pjyxqdo9u.bkt.clouddn.com/xiao.png";
